      ...
      <div style={{ flex: 1, padding: '28px 24px' }}>
        ...
        <div className="input-group">
          ...
          <div className="input-wrapper has-icon">
            ...
            <input className="input-field" type={showPass ? 'text' : 'password'} placeholder="Shkruaj fjalëkalimin" />
        ...
        <button className="btn btn-primary btn-full" onClick={() => navigate('/home')} style={{ marginBottom: 16, padding: '16px' }}>Hyr</button>

        <div className="divider-text">ose vazhdo me</div>

        <button className="btn btn-secondary btn-full" style={{ marginBottom: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
          <GlobeIcon size={17} color="var(--text-secondary)" strokeWidth={1.8} /> Vazhdo me Google
        </button>
